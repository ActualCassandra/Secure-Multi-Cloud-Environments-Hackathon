...
Depending on the specific hack, you will need to have access to tenants in:
 ...
 - [Amazon Web Services (AWS)](https://aws.amazon.com/free/) 
   - [Step by step sign-up steps](https://github.com/ActualCassandra/SecuringMultiVendorCloudsPart2/blob/main/Labs/Modules/Preparing-the-Environments.md#steps-to-create-your-aws-trial-account) or/and
